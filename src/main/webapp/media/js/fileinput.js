...
(function (factory) {
    ...
    tMain1 = '{preview}\n' +
        ...
        '   </div>\n' +
        '</div>';
    tMain2 = '{preview}\n<br/><div class="kv-upload-progress hide"></div>\n{remove}\n{cancel}\n{upload}\n{browse}\n';
...
//            return true;
        ...
        _createContainer: function () {
            var self = this, $container = $(document.createElement("div"))
                .attr({"class": 'file-input span10 file-input-new'})
        ...
        _renderMain: function () {
            var self = this, dropCss = (self.isUploadable && self.dropZoneEnabled) ? ' file-drop-zone' : 'file-drop-disabled',
                ...
                caption = self.captionTemplate.replace(/\{class}/g, css + ' span4 kv-fileinput-caption');
